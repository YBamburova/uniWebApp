...
<div class="container" style="padding-top: 10px">
    ...
    <div class="row">
      <div class="col-md-4">
          <div class="card mb-4 box-shadow">
              <img class="card-img-top" alt="Photo" src="https://i.ibb.co/2thm7Fq/Screenshot-230.png" style="height: 325px; width: 100%; display: block;">
            <div class="card-body">
          ...
          <div class="card mb-4 box-shadow">
              <img class="card-img-top" alt="Photo" src="https://i.ibb.co/Zfyn2ft/Screenshot-231.png" style="height: 325px; width: 100%; display: block;">
              <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 box-shadow">
        <img class="card-img-top" alt="Photo" src="https://i.ibb.co/QF6Kh3Q/photo2700592079455758249.jpg"  style="height: 325px; width: 100%; display: block;">
        <div class="card-body">
