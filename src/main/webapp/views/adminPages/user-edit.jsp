            ...
            <form action="${pageContext.request.contextPath}/users" method="post">
                <div class="mb-3">
                    ...
                    <input minlength="3" maxlength="45" id="username" class="form-control"
                           placeholder="<spring:message code="LocaleUsername"/>" type="text" name="username"
                ...
                <div class="mb-3">
                    ...
                    <input minlength="3" maxlength="45" id="surname" class="form-control"
                           placeholder="<spring:message code="LocaleSurname"/>" type="text" name="surname"
                ...
                <div class="mb-3">
                    ...
                    <input pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" maxlength="45" id="email" class="form-control"
                           placeholder="<spring:message code="LocaleEmail"/>" type="text" name="email"
                ...
                <div class="mb-3">
                    ...
                    <input pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" maxlength="45" minlength="8"
                           id="password" class="form-control" placeholder="<spring:message code="LocalePassDescription"/>"
