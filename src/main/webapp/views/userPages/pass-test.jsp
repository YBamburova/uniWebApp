...
<head>
    ...
    <title><spring:message code="LocaleTestInProgress"/>
    </title>
</head>
<body>
<div class="container pt-5">
    <div style="position: sticky; top: 0; z-index: 2; width: 100%"
         class="card align-items-center bg-white mb-5">
        <h3><spring:message code="LocaleTimeLeft"/>
        </h3>
        <div class="badge" style="font-size: 35px; margin-bottom: 20px" id="clock"></div>
        <button form="testForm" class="btn btn-warning align-self-end" style="width: 100%">Submit
            test
        </button>
    </div>
        ...
        <c:forEach varStatus="loop" items="${list}" var="question">
            ...
            <div class="card question mb-5">
                ...
                <div class="form-check d-flex align-items-center mb-2">
                    <input class="form-check-input position-static mt-0 mr-2" value="true"
                           type="checkbox"
                           name="${question.id}1">
                        ${question.option1}
                </div>
                ...
                <div class="form-check d-flex align-items-center mb-2">
                    <input class="form-check-input position-static mt-0 mr-2" type="checkbox"
                           value="true"
                           name="${question.id}2">
                        ${question.option2}
                </div>
